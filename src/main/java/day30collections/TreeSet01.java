...
public class TreeSet01 {
    ...
    /*
    Java'da tree kelimesi alfabetik sıralama veya küçükten büyüğe sıralama demektir.
    TreeSet tekrarsız elemanları "alfabetik" veya "küçükten büyüğe"(Natural Order) dizer.

    TreeSet çooook yavaş çalışır. TreeSet kullanırken iki kere düşünmelisiniz.
    Gerçekten alfabetik sıralama veya küçükten büyüğe sıralama çok önemli olmalıdır.
    Genelde TreeSet kullanmaktan kaçınırız.
    ...
    */
    ...
    /* Interview Sorusu
    Note: Tekrarsız elemanları natural order da depolamak için TreeSet kullanmak mantıklıdır
    ama TreeSet'ler çooook yavaş çalıştığı için biz elemanları önce HashSet'e depolarız sonra HashSet'i TreeSet'e çevirerek
    TreeSet'in yavaş olma problemini aşmış oluruz.
     */
